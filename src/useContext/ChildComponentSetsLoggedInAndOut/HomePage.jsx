 ...
 * method and empty account info from the logout method. 
 * The provider provides everything you need to show/hide Account Balance
 * and toggle the "login"/"logout" text on the button inside <Avatar />.
 * Avatar tells AccountPage to set the logged in/out state on BankAccountContext.
